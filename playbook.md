...
3. Download apps as I need them rather than spending precious time upfront getting them set up. I may find I don't use the app and didn't need it after all. See previous point about the browser.

As much as I am trying to follow the above. There are a couple of holdout apps for me:

* [Alfred](https://www.alfredapp.com/) - more powerful than Spotlight. Trigger with a hotkey. Don't currently have Powerpack which brings a lot more features and workflows
...
* Various productivity apps ([Aware](https://awaremac.com/), [Time Out](https://www.dejal.com/timeout/))
